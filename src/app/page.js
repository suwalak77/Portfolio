      ...
      <section className="relative z-10 flex flex-col md:flex-row items-center justify-center min-h-screen px-10 md:px-20 pt-0.01 pb-2">
        ...
        <div className="flex items-center justify-center min-h-screen w-full">
          ...
          >
            ...
            >
              ฉันเป็นนักศึกษาที่มีความกระตือรือร้นและมุ่งมั่นในการเรียนรู้สิ่งใหม่ ๆ เสมอ
              <br />
              ฉันมีทักษะการเรียนรู้ที่เร็วและสามารถทำงานร่วมกับผู้อื่นได้ดี
              <br />
              พร้อมเปิดใจเรียนรู้และพัฒนาทักษะต่าง ๆ ให้ก้าวหน้าอยู่เสมอ
            </motion.p>
          </motion.div>
        </div>
